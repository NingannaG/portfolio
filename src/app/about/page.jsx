  ...
  return (
    <>
      <div className="mx-36 px-5">
        ...
        <div className="text-xl text-justify py-5">
        ...
        <div className="my-10">
          ...
          <h1 className="text-xl">
            MCA Karnataka University of Mysore May.2022 – Still pursuing BCA
          </h1>
          <br />
          <h1 className="text-xl">
            Karnataka, Vedant BCA & B. Com college Vijayapura June.2017 –
            May.2020
          </h1>
          Percentage:75%
        </div>
